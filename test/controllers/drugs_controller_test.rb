...
class DrugsControllerTest < ActionController::TestCase
  ...
  test "should create drug" do
    assert_difference('Drug.count') do
      post :create, drug: { age: @drug.age, cost: @drug.cost, description: @drug.description, firm: @drug.firm, firstname: @drug.firstname, lastname: @drug.lastname }
    end
  ...
  test "should update drug" do
    patch :update, id: @drug, drug: { age: @drug.age, cost: @drug.cost, description: @drug.description, firm: @drug.firm, firstname: @drug.firstname, lastname: @drug.lastname }
    assert_redirected_to drug_path(assigns(:drug))
  end
